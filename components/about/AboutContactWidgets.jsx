     ...
     return(
          <div className='bg-white w-screen md:h-[50vh] flex flex-col md:flex-row'>
               ...
               <div className='w-full md:w-[33.3vw] h-full bg-slate-100 flex flex-col gap-y-5 items-start justify-center p-10 sm:p-20 md:p-10 xl:p-20'>
                         ...
                         <Link href='/contact' className='text-sm xl:text-lg bg-violet-900 px-5 xl:px-10 py-3 xl:py-5 font-bold text-white flex items-center gap-x-2 hover:bg-sky-300 shadow-lg rounded-lg transition-colors'>
                              <span>Salúdanos</span>
