          ...
          <div className='w-screen h-screen flex flex-col'>
               ...
               <div className='w-full md:h-[50vh] flex flex-col md:flex-row'>
                    ...
                    <div className='w-full md:w-[33.3vw] h-full bg-slate-100 flex flex-col gap-y-5 items-start justify-center p-10 sm:p-20 md:p-10 xl:p-20'>
                         ...
                         <p className='text-gray-500 font-light text-sm xl:text-md'>Nuestro trabajo ha incrementado la reputación y presencia online de nuestros clientes. Combinamos servicios de identidad de marca, marketing digital y desarrollo web para que nuestros clientes no tengan que preocuparse por lo difícil que puede llegar a ser.</p>
               ...
               <div className='w-full md:h-[50vh] flex flex-col md:flex-row'>
                    ...
                    <div className='w-full md:w-[33.3vw] h-full bg-red-500 flex items-center justify-center p-10 sm:p-20 md:p-10 xl:p-20'>
                         <h2 className='text-white font-bold text-2xl xl:text-6xl'>HABILIDADES</h2>
                    </div>
                    {/* widget 2 */}
                    ...
                    <div className='w-full md:w-[33.4vw] h-full bg-slate-100 flex flex-col items-start justify-center p-10 sm:p-20 md:p-10 xl:p-20 gap-y-5'>
                         <h2 className='text-4xl xl:text-5xl font-bold w-full'>REDES SOCIALES</h2>
                         <p className='text-gray-500 font-light text-sm xl:text-md'>Mantenemos nuestras redes sociales actualizadas con avances, diseños y más. ¡Contáctanos!</p>
                         <button className='text-sm xl:text-lg bg-violet-900 px-5 xl:px-10 py-3 xl:py-5 font-bold text-white flex items-center gap-x-2 hover:bg-sky-300 shadow-lg'>
                              <span>Ver más</span>
                              <ChevronRightIcon className='w-3 xl:w-5' />
                         </button>
