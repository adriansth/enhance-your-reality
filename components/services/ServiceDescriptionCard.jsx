...
export default function ServiceDescriptionCard({ name, description, available, image, link }) {
     return(
          <Link href={`/services/${link}`} className='w-full lg:w-[275px] border flex flex-col justify-between rounded-lg hover:scale-105 transition-transform cursor-pointer shadow-lg hover:bg-slate-100'>
               {/* info */}
