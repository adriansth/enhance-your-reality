export default function AboutDescription() {
   return(
      <div className='bg-white w-screen py-20 px-10 md:px-20 flex flex-col gap-y-5 text-justify'>
         ...
         <p className='text-gray-500 font-light text-xl'>
            Somos tu mejor aliado, el socio que estabas esperando; <span className='text-violet-900 font-semibold'>escuchamos tus planes y objetivos para poder apoyarte de la mejor manera</span> con nuestra experiencia y conocimientos en las tecnologías y tendencias más actualizadas.
         </p>
         <p className='text-gray-500 font-light text-xl'>
            Las propuestas que te brindamos son <span className='text-violet-900 font-semibold'>soluciones de tecnología de la más alta calidad</span>, cumpliendo con los más altos estándares de la industria y de esta manera impulsar tu negocio o proyecto hacia el éxito.
         </p>
         <p className='text-gray-500 font-light text-xl'>
         ...
         <p className='text-gray-500 font-light text-xl'>
            Contáctanos hoy mismo para saber cómo podemos ayudarte a impulsar tu negocio hacia el éxito.
         </p>
      </div>
   );
}